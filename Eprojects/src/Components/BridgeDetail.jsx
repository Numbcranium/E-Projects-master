...
//         <div className="bridge-image" style={{ backgroundImage: `url(${bridge.images[0]})` }} />
...
//         )}
//       </div>
//       <div className="bridge-attributes">
//         <div className="bridge-attributes-header">STATS AND FACTS</div>
//         <div className="bridge-attribute height">
//           <div>
//             <div className="attribute-title">Height</div>
//             <div className="attribute-value">{bridge.attributes.height_meters} meters</div>
//           </div>
//           <div className="attribute-index">01</div>
//         </div>
//         <div className="bridge-attribute year">
//           <div>
//             <div className="attribute-title">Year Created</div>
//             <div className="attribute-value">{bridge.attributes.opened_year}</div>
//           </div>
//           <div className="attribute-index">02</div>
//         </div>
//         <div className="bridge-attribute length">
//           <div>
//             <div className="attribute-title">Length</div>
//             <div className="attribute-value">{bridge.attributes.length_meters} meters</div>
//           </div>
...
const BridgeDetail = () => {
  ...
  return (
    <>
      ...
      <div className="bridge-bottom-section">
        <div className="bridgemap">
          {bridge && bridge.location && bridge.location.coordinates && typeof bridge.location.coordinates.latitude === 'number' && typeof bridge.location.coordinates.longitude === 'number' ? (
            <BridgeMap
              latitude={bridge.location.coordinates.latitude}
